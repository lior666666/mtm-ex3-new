...
namespace mtm {
    ...
    public:
        ...
        */ 
        ...
        /**
        *  addElement: Adds a new element to the list by it's priotity by operator< that is provided by the user.
        *  In case the element already in the list, it won't add it again!
        ...
        *  Iterator is undefined after the function is done.
        * @param data - the data that needs to be added to the queue. 
        * @param location - a pointer that points to one of the elements in the list, and the data will
        *    be inserted in a new elemnt after the location. 
        */
        ...
        /**
        * removeElement: Removes an element from the queue with the same data as received.
